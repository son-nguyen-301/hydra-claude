...
- After a subagent completes implementation, use the `review-code` skill to spawn the `code-reviewer` agent for an independent code review. Do not skip this step.
